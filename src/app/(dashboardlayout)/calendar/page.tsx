...
const events: Record<string, { label: string; color: string }[]> = {
  ...
  "2025-02-26": [
    { label: "Maha Shivratri", color: "bg-purple-400 text-white" },
  ],
  "2025-08-15": [
    { label: "Independence Day", color: "bg-green-400 text-white" },
  ],
  "2025-09-13": [{ label: "Birthday", color: "bg-green-700 text-white" }],
  "2025-08-27": [
    { label: "Krishna Janmashtami", color: "bg-blue-400 text-white" },
  ],
  "2025-08-29": [
    { label: "Vinayaka Chavithi", color: "bg-yellow-400 text-white" },
  ],
